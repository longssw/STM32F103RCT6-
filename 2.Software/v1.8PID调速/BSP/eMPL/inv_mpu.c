...
******************************************************************************
* 文件名:   inv_mpu.c
* 日期:     2022-04-14 21:20:53
* 作者:     善思维
* 版本:     1.0
* 功能描述:使用时调用mpu_dmp_init函数即可完成配置
*           调用mpu_dmp_get_data可读取角度
*******************************************************************************
*/
/*=============================== 头文件包含 ==================================*/
...
******************************************************************************
以下代码说明:
//奇奇怪怪的汇编指令,来源于正点原子的例程,原本是用来重定义printf的
//只要它留着就没有问题
//不知道为什么,一删掉就崩溃
//如果哪天报错了,就添加头文件#include "stdio.h"
//当下列函数不存在时,如果使用mpu_dmp_init();程序将会崩溃
//日期:2022/4/13
//发现者:ssw
******************************************************************************
*/
